...
class indexAction extends CommonAction {
    ...
    public function main() {
        ...
        $tripec_authorization_info = $this->get_tripec_authorization();
        switch ($tripec_authorization_info) {
            case -1:$this->assign("auth_info", "未授权");
                break;
            case 1:$this->assign("auth_info", "商业授权");
                break;
        }
        $this->assign("newest_version", Http::getCurl('http://www.tripec.cn/copyright/checkversion?v=' .urlencode(C("TRIPEC_VERSION")) ));
