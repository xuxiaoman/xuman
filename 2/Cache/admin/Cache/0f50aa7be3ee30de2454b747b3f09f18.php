<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
    ...
    </script></head><body width="100%"><div id="result" class="result none"></div><div class="mainbox"><div id="nav" class="mainnav_title"><ul><a href="<?php echo U('bakup/index');?>">数据库备份</a> |        <a href="<?php echo U('bakup/import_list');?>"  class="on">数据库还原</a></ul></div><div class="table-list"><table cellspacing="0" cellpadding="0" width="100%"><tr align="center"><td>文件名</td><td>文件大小</td><td>份时间</td><td>卷号</td><td width="20%">操作</td></tr><?php if(is_array($file_list)): $i = 0; $__LIST__ = $file_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$file): $mod = ($i % 2 );++$i; if(is_array($file)): $i = 0; $__LIST__ = $file;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$id): $mod = ($i % 2 );++$i;?><tr><td style="text-align:left;"><?php if(($id["num"]) == "0"): ?><a href="<?php echo U('bakup/import',array('file'=>$id['filename']));?>"><?php echo ($id['filename']); ?></a><?php else: ?>                            &nbsp;&nbsp;&nbsp;<?php echo ($id['filename']); endif; ?></td><td><?php echo ($id["filesize"]); ?> K</td><td><?php echo ($id["maketime"]); ?></td><td><?php echo ($id["num"]); ?></td><td><?php if(($id["num"]) == "0"): ?><a href="<?php echo U('bakup/import',array('file'=>$id['filename']));?>" onclick="return confirm('在导入之前请确认你的备份所有分卷都存在，否则有可能会出现未知的错误')">导入</a>                            |<?php endif; ?><a href="<?php echo U('bakup/delfile',array('file'=>$id['filename']));?>" onclick="return confirm('您确认要删除此数据库备份?一旦删除，将不可恢复。请谨慎操作')">删除</a>                        | <a href="<?php echo U('bakup/down',array('file'=>$id['filename']));?>">下载</a></td></tr><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?></table></div></div></body></html>