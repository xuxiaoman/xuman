...
<div style="margin-top:12px;"></div>
    <div class="col-18 alpha alpha_nav "><div class=" title on">旅游路线收藏</div></div>
    <div class="col-18 alpha body">
        <table width="100%" class="table_list">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="<?php echo U('travel/detail',array('id'=>$vo['id']));?>"><?php echo ($vo["names"]); ?></td>
                    <td><a href="<?php echo U('userline/route_coll_del',array('id'=>$vo['kid']));?>" onclick="return confirm('确定删除该收藏吗?',this.href)">删除</a></td>
