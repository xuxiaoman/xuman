...
<ul class="sideMenu">
    ...
    <ul class="sm_list">
      ...
      <li><a href="<?php echo U('userinfo/message_list');?>">我的短信</a></li>
		...
		<link rel="stylesheet"  href="../Public/css/route_q.css"/>
        <div class="col-19 omega page_content one route_review_nav">
        <div style="margin-top:12px;"></div>
         <li><a href="#" class="col-2 title on col-full">旅游线路点评</a>
        	 <a href="<?php echo U('userline/route_mag');?>" class="col-2 alpha title ">我要点评</a>
         </li>
            <div class="col-18 alpha body">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="content_main_right_massage-box">
                	<div class="title"><b>编号：</b><?php echo ($vo["code"]); ?></div>
                    <div class="title"><b>路线名称：</b><?php echo ($vo["names"]); ?></div>
                    <div class="title"><b>行程：</b><span class="rev_font"><?php echo ($vo["travel"]); ?></span>&nbsp;&nbsp;<b>导游：</b><span class="rev_font"><?php echo ($vo["guide"]); ?></span>&nbsp;&nbsp;<b>交通：</b><span class="rev_font"><?php echo ($vo["traffic"]); ?></span>&nbsp;&nbsp;<b>住宿：</b><span class="rev_font"><?php echo ($vo["room"]); ?></span>&nbsp;&nbsp;<b>满意度：</b><span class="rev_font"><?php echo ($vo["point"]); ?></span>&nbsp;&nbsp;<b>点评奖金：</b><span class="rev_font"><?php if(($vo['review_award']!='') OR ($vo['review_award']!='0')): echo ($vo["review_award"]); ?>元<?php else: ?>无<?php endif; ?></span></div>
    <div class="title"><?php echo ($vo["content"]); ?></div>
    <div class="title"><b>印象：</b><span class="rev_font"><?php if(is_array($vo['impr_name'])): $i = 0; $__LIST__ = $vo['impr_name'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i; echo ($vo2); endforeach; endif; else: echo "" ;endif; ?></span></div>                
