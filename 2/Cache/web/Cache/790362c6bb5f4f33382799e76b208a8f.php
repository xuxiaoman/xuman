...
<script src="../Public/js/userhotel.js" type="text/javascript"></script>
	<div class="col-19 omega page_content page_content_nav">
   <div style="margin-top:12px;"></div>
		<div>
        	<ul class="side" style="width:890px;margin-left:14px">
              <li>
              	<a class="col-2 alpha title col-full <?php if(($status) == ""): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>">全部</a>
              </li>
              <li><a class="col-2 title <?php if(($status) == "0"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/0">待处理</a></li>
              <li><a class="col-2 title <?php if(($status) == "1"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/1">待付款</a></li>
              <li><a class="col-2 title <?php if(($status) == "2"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/2">已付款</a></li>
              <li><a class="col-2 title <?php if(($status) == "3"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/3">已入住</a></li>
              <li><a class="col-2 title <?php if(($status) == "4"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/4">已点评</a></li>
              <li><a class="col-2 title <?php if(($status) == "5"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/5">已结束</a></li>
              <li><a class="col-2 title <?php if(($status) == "6"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/6">已取消</a></li>
              <li><a class="col-2 title <?php if(($status) == "7"): ?>on<?php endif; ?>" href="<?php echo U('hotel');?>/status/7">撤单中</a></li>
            </ul>
            <div class="col-18 alpha body" style="margin-left:14px">
            	<table width="100%" class="table_list">
                    ...
                    <?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      <td><a href="<?php echo U('hotel_userorder');?>/id/<?php echo ($vo["order_id"]); ?>"><?php echo ($vo["order_id"]); ?></a></td>
                      <td><a href="<?php echo U('./hotel/hotel_detailed');?>/hotel/<?php echo ($vo["hotelid"]); ?>"><?php echo ($vo["hotelname"]); ?>/<?php echo ($vo["roomname"]); ?></a></td>
                      <td><?php echo (date("Y-m-d",$vo["come_date"])); ?></td>
                      <td><?php echo ($vo["all_money"]); ?>元</td>
                      <td><?php echo ($vo["bonus_comm"]); ?>元</td>
                      <td><?php echo (date("Y-m-d",$vo["add_time"])); ?><br /><?php echo (date("H:i:s",$vo["add_time"])); ?></td>
                      <td>
                       <?php switch($vo["status"]): case "0": ?>待处理<?php break;?>
                         <?php case "1": ?>待付款<?php break;?>
                         <?php case "2": ?>已付款<?php break;?>
                         <?php case "3": ?>已入住<?php break;?>
                         <?php case "4": ?>已点评<?php break;?>
                         <?php case "5": ?>已结束<?php break;?>
                         <?php case "6": ?>已取消<?php break;?>
                         <?php case "7": ?>申请撤单中<?php break; endswitch;?>
                      </td>
                      <td><a href="<?php echo U('hotel_userorder');?>/id/<?php echo ($vo["order_id"]); ?>">查看</a><?php switch($vo["status"]): case "0": ?>|<a href="javascript:;" class="change-status" url="<?php echo U('order_control');?>/status/6/id/<?php echo ($vo["order_id"]); ?>">撤销</a><?php break;?>
                      <?php case "1": ?>|<a href="javascript:;" class="change-status" url="<?php echo U('order_control');?>/status/6/id/<?php echo ($vo["order_id"]); ?>">撤销</a>|<a href="<?php echo U('hotel/hotel_pay');?>/id/<?php echo ($vo["order_id"]); ?>">付款</a><?php break;?>
                      <?php case "2": ?>|<a href="javascript:;" class="change-status" url="<?php echo U('order_control');?>/status/6/id/<?php echo ($vo["order_id"]); ?>">撤销</a><?php break;?>
                      <?php case "3": ?>|<a href="<?php echo U('order_control');?>/status/4/id/<?php echo ($vo["order_id"]); ?>">点评</a><?php break;?>
                      <?php case "4": ?>|<a href="<?php echo U('hotel_review');?>?order_id=<?php echo ($vo["order_id"]); ?>">查看点评</a><?php break;?>
                      <?php case "5": ?>|<a href="<?php echo U('hotel_review');?>?order_id=<?php echo ($vo["order_id"]); ?>">查看点评</a><?php break;?>
                      <?php case "7": ?>|<a href="javascript:;" class="change-status" url="<?php echo U('order_control');?>/status/auto/id/<?php echo ($vo["order_id"]); ?>">恢复</a><?php break; endswitch;?>
                      </td>
