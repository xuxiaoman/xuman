...
<link rel="stylesheet" href="../Public/css/route_q.css"/>
  <div class="col-19 omega page_content one1">
  <div style="margin-top:12px;"></div>
      <li ><div class="col-2 alpha title on col-full questions">景点问答</div></li>
        <div class="col-18 alpha body">
        <?php if(is_array($questions)): $i = 0; $__LIST__ = $questions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table width="100%" class="table_list questions">
            <tr>
              <th>我对&nbsp;<font color="#3333FF"><?php echo ($vo["names"]); ?></font>&nbsp;问：<span><?php echo ($vo["question1"]); ?></span></th>
            </tr>
            <tr>
              <th>
                <?php if($vo["status"] == 0): ?><span class="hotel_wait">请等待回复...</span>
                <?php else: ?>答：<span><?php echo ($vo["answer"]); ?></span><?php endif; ?>
              </th>
            </tr>
            <tr>
              <td>
              <div class="que_time">提问时间：<?php echo (date("Y年m月d日 H:i:s",$vo["publish_time"])); ?>
              <?php if(($vo["status"]) == "1"): ?>&nbsp;&nbsp;&nbsp;&nbsp;回答时间：<?php echo (date("Y年m月d日 H:i:s",$vo["answer_time"])); endif; ?>
            </div>
              </td>
            </tr>
