...
<ul class="sideMenu">
    ...
    <ul class="sm_list">
      ...
      <li><a href="<?php echo U('userinfo/message_list');?>">我的短信</a></li>
		...
		<link rel="stylesheet"  href="../Public/css/route_q.css"/>
<div class="col-19 omega page_content route_questions_nav">
<div style="margin-top:12px;"></div>
    <div class="col-4 alpha title on">旅游线路问答</div>
    <div class="col-18 alpha body">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="route_q_a">
                <div class="route_questions">你在<a href="<?php echo U('travel/detail',array('id'=>$vo['id']));?>"><?php echo ($vo["names"]); ?></a>线路中问：<?php echo ($vo["question1"]); ?></div>
                <?php if($vo["status"] == '1'): ?><div class='route_wait'>请等待回复...</div><?php else: ?><div class='route_answer'><?php echo ($vo["answer"]); ?></div><?php endif; ?>
            </div><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
  <div class="col-18 page page_nav"><?php echo ($page); ?></div>
</div>
