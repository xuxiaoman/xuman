    ...
    <div class="row">
      <table>
        <tr>
          <td class="list"><div>
              <ul>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="
                    <?php if(($detailtype) == "0"): echo U('detail');?>?detail=<?php echo ($vo["id"]); ?>
                    <?php else: ?>
                      <?php echo U('notice'); endif; ?>">
                    <li 
                      <?php if(($vo["id"]) == $content['Section_id']): ?>class="on"<?php endif; ?>><?php echo ($vo["names"]); ?><span>&gt;</span>
                    </li>
                  </a><?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
            </div></td>
          <td class="content" height="450px;"><div class="body"><?php echo ($content["content"]); ?></div></td>
        </tr>
      </table>
    </div>
  </div>
