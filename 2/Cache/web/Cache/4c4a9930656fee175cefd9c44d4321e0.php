...
<div>
  ...
  <div style="margin-top:12px;"></div>
    <li>
      <a href="<?php echo U('hotel_review');?>" class="col-3 title <?php if(($status) == "2"): ?>on<?php endif; ?> col-full">已审核点评</a>
      <a href="<?php echo U('hotel_review');?>/status/1" class="col-3 <?php if(($status) == "1"): ?>on<?php endif; ?> title add">待审核点评</a>
      <a href="<?php echo U('hotel');?>/status/3" class="col-3 title add">我要点评</a>
    </li>
    <?php if(is_array($imprs)): $i = 0; $__LIST__ = $imprs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-18 alpha body">
        <div class="content_main_right_massage-box">
          <div class="title"><b>编号：</b><?php echo ($vo["orderid"]); if(($vo["status"]) == "1"): ?><span style="color:#F33">（审核中）</span><?php endif; ?></div>
          <div class="title"><b>酒店/房间：</b><?php echo ($vo["hotel_name"]); ?> / <?php echo ($vo["room_name"]); ?></div>
          <div class="title"><b>设备装潢：</b><span class="rev_font"><?php echo ($vo["decoration"]); ?></span>&nbsp;；&nbsp;<b>交通位置：</b><span class="rev_font"><?php echo ($vo["traffic"]); ?></span>&nbsp;；&nbsp;<b>卫生情况：</b><span class="rev_font"><?php echo ($vo["hygiene"]); ?></span>&nbsp;；&nbsp;<b>性价比：</b><span class="rev_font"><?php echo ($vo["prices"]); ?></span>&nbsp;；&nbsp;<b>满意度：</b><span class="rev_font"><?php echo ($vo["points"]); ?>%</span>
            <?php if(($vo["status"]) == "2"): ?>&nbsp;；&nbsp;<b>点评奖金：</b><span class="rev_font"><?php echo ($vo["bonus_comm"]); ?>元</span><?php endif; ?>
          </div>
          <div class="title"><?php echo ($vo["content"]); ?></div>
          <div class="title"><b>印象：</b><span class="rev_font"><?php echo ($vo["imprs"]); ?></span></div>
        </div>
