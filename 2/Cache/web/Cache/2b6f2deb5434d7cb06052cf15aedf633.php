...
<script type="text/javascript" src="../Public/js/bank_js_one.js"></script>
<script type="text/javascript" src="../Public/js/bank_js_two.js"></script>
<div class="wrapper w1200" style="background: #FFF;">
    <div class="clear"></div>
    <div class="col-24 step_top" style="padding-left:20px;">
        <div class="col-6 step"><img class="step_img" width="100%" src="/web/Tpl/green2/Public/images/step_bg.png"></img><span class="offset-2 step_font">1.选择路线</span></div>
        <div class="col-6 step_two"><img width="100%" src="/web/Tpl/green2/Public/images/step_bg3.png"></img><span class="offset-2 step_font">2.提交订单</span></div>
        <div class="col-6 step_three"><img width="100%" src="/web/Tpl/green2/Public/images/step_bg2.png"></img><span class="offset-2 step_font">3.等待支付</span></div>
        <div class="col-6 step_four"><img width="100%" src="/web/Tpl/green2/Public/images/step_bg4.png"></img><span class="offset-2 step_font">4.支付完成</span></div>
    </div>
    <div class="untreated1">
        <form action="<?php echo U('lineorder/form');?>" method="post" name="myform" id="myform" target='_blank'>
        <div class="untreated_main">
            ...
            <div class="visitor">
                <table width="896px" class="table_list">
                    ...
                    <tr>
                        ...
                        <td><?php echo (f_date($usinfo["go_time"])); ?></td>
           ...
           <!-- <div class=""><input type="checkbox" id="check_lb" name="psw_on">
                <label for="check_lb">余额还有：<?php echo ($amount); ?></label>
                <div class="clear"></div>
                <div class=""><input type="password" name="password">
                <input type="hidden" value="<?php echo ($usinfo['id']); ?>" name="order_id">
                </div>
            ...
            <div class="payments">
                <div id="tabbox">
                    <ul class="tabs" id="tabs">
                        <li><a href="http://www.51xuediannao.com/js/nav/">储蓄卡</a></li>
                        <li><a href="http://www.51xuediannao.com/js/slide/">信用卡</a></li>
                    </ul>
                    <ul class="tab_conbox" id="tab_conbox">
                        <li class="tab_con">
							<?php if(is_array($banks['data'][1])): $i = 0; $__LIST__ = $banks['data'][1];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="tab_con_bank">
                                <input type="radio" id="wangyin1_<?php echo ($vo["class"]); ?>" name="bank" value="<?php echo ($vo["code"]); ?>">
                                <label  id="<?php echo ($vo["class"]); ?>_label" for="wangyin1_<?php echo ($vo["class"]); ?>" class="bank <?php echo ($vo["class"]); ?>"><img src="<?php echo ($vo["icon"]); ?>"/></label>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                        </li>
                        <li class="tab_con">
                            <?php if(is_array($banks['data'][2])): $i = 0; $__LIST__ = $banks['data'][2];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="tab_con_bank">
                                <input type="radio" id="wangyin1_<?php echo ($vo["class"]); ?>" name="bank" value="<?php echo ($vo["code"]); ?>">
                                <label  id="<?php echo ($vo["class"]); ?>_label" for="wangyin1_<?php echo ($vo["class"]); ?>" class="bank <?php echo ($vo["class"]); ?>"><img src="<?php echo ($vo["icon"]); ?>"/></label>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                        </li>
                    </ul>
                    <input type="hidden" name="used_card" value="<?php echo ($usinfo["used_card"]); ?>" id="used_card">
                    <input type="hidden" name="order_id" value="<?php echo $_GET['order_id'];?>" id="order_id">
                    <input type="hidden" name="MerchantID" value="<?php echo C('MerchantID');?>" id="MerchantID">
                    <input type="hidden" name="amount" value="<?php echo ($usinfo["earnest"]); ?>" id="amount">
                </div>
            </div>
            <div class="handle_btn">
							<div class="handle_btn_one"> 
					<button type="submit" class="btn3 btn primary orange">下一步</button> 
				</div>
                <div class="handle_btn_one">
