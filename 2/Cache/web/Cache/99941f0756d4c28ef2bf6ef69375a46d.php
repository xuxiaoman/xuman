    ...
    <ul class="sm_list">
      ...
      <li><a href="<?php echo U('userinfo/message_list');?>">我的短信</a></li>
		...
		<div class="col-19 omega page_content">
        	<div class="col-4 alpha title on">收件箱</div>
            <div class="col-18 alpha body">
            	<table width="100%" class="table_list">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><a href="<?php echo U('message_del',array('id'=>$vo['id']));?>" onclick="return atr_confirm(this.href,'确定撤销该订单吗?')">删除</a>&nbsp;&nbsp;<a href="<?php echo U('short_message',array('id'=>$vo['id']));?>">查看</a></td>
